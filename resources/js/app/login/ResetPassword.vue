    ...
    <v-container class="d-flex justify-center align-center" style="height:80vh; width: 100%;">
        <v-card class="mx-auto" max-width="700" width="100%">
            <v-card-text class="mb-0">
                <h2 class="font-weight-black text-center mt-4 red--text"> Réinitialiser votre mot de passe </h2>
            ...
            <div class="d-flex justify-center mb-4">
                <v-form ref="form" v-model="valid" lazy-validation style="width: 80% !important;">
                    ...
                    <div v-else>
                        <v-text-field type="password" v-model="password" :rules="passwordRules" label="Nouveau mot de passe"  required style="margin-bottom: 0px! important;"></v-text-field>
                    ...
                    <div class="d-flex justify-end my-2 w-100">
                        ...
                        <v-btn small color="primary" @click="sendEmail" v-if="!isTokenExist"> Réinitialiser</v-btn>
                        <v-btn small color="primary" @click="validate" v-else> Réinitialiser</v-btn>
                    </div>
                </v-form>
            </div>
        </v-card>
